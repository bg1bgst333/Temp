...
int CMainWindow::OnCreate(HWND hwnd, LPCREATESTRUCT lpCreateStruct) {
	...
	// ピクチャーコントロールの作成.
	m_pPicture->Create(_T(""), WS_BORDER | SS_REALSIZECONTROL, 450, 80, 320, 240, hwnd, (HMENU)(WM_APP + 4), lpCreateStruct->hInstance);	// m_pStatic->Createでピクチャーコントロールを作成.(SS_REALSIZECONTROLはコントロールの大きさに合わせて縮小され, SS_REALSIZEIMAGEは画像サイズに合わせてコントロールが拡大する.)
